...
;; ## added by OPAM user-setup for emacs / ocp-indent ## ff1acc07e5461202a87daa9655feec62 ## you can edit, but keep this line
;; Load ocp-indent from its original switch when not found in current switch
(when (not (member "ocp-indent" opam-tools-installed))
  (autoload 'ocp-setup-indent "/home/tarffie/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Tuareg mode")
  (autoload 'ocp-indent-caml-mode-setup "/home/tarffie/.opam/default/share/emacs/site-lisp/ocp-indent.el" "Improved indentation for Caml mode")
  (add-hook 'tuareg-mode-hook 'ocp-setup-indent t)
  (add-hook 'caml-mode-hook 'ocp-indent-caml-mode-setup  t)
  (setq ocp-indent-path "/home/tarffie/.opam/default/bin/ocp-indent"))
